    ...
    try:
        if 'youtube.com' in url or 'youtu.be' in url:
            ...
            try:
                ...
                # If pytube fails, use yt-dlp as fallback
                try:
            ...
            return None, "Instagram reel video downloading is not supported."
        else:
...
def index():
    ...
    <html lang="en">
      ...
      <title>VideoPaze.com - Video Downloader</title>
      ...
      <div class="container">
        ...
        <p>Enter a valid YouTube video URL below:</p>
        <form method="post">
